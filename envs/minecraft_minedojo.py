...
from minedojo.sim import handler
# from minedojo.sim import handlers
# from minedojo.sim.mc_meta import mc
# from minedojo.sim.mc_meta.mc import INVERSE_KEYMAP
...
#             handlers.CraftWithTableAction(["none"] + mc.ALL_ITEMS, **kw),
#             handlers.SmeltAction(["none"] + mc.ALL_ITEMS, **kw),
#         ]
